function [stm,S] = LSPstimulusGeneration(targetContrast,targetContrastAngle,posXoffsetPix,frqCpd,phsDeg,ortDeg,BWoct,cmpIntrvl)
...
%               posXoffsetPix = 3.*ones([size(cmpIntrvl,1) 1]);
%               [stm,~] = LSPstimulusGeneration(targetContrast,targetContrastAngle,posXoffsetPix,1,0,0,0.932,cmpIntrvl);
%
% generates chromatic gabor stimuli for LMS experiment
%
% inputs: 
%             targetContrast     : cone contrasts 
%                                   [nCnd x 3]
%             targetContrastAngle: cone angles in L-S plane 
%                                   [nCnd x 3]
%             posXoffsetPix      : position offset
